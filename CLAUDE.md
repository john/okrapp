...
There should be admin pages which you can reach only if your email address is jmcgrath@rmi.org, cbloch@rmi.org, or rhall@rmi.org. It will contain links to:
...
The design of the site--colors, fonts, styles, etc--shoudl be similar to https://rmi.org/
...
- Add organizations (programs and initiatives), including the UI to view, forms to add, admin page to associate users with organizations, and associated API endpoints. Make sure you can only view these pages if you're logged in with an rmi.org email, and only view admin pages if your email is jmcgrath@rmi.org, cbloch@rmi.org, or rhall@rmi.org
